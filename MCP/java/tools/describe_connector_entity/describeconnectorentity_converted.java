/**
 * MCP Server function for Provides details regarding the entity used with the connector, with a description of the data model for each field in that entity.
 */
...
class Post_Describe_Connector_EntityMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_Describe_Connector_EntityHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("connectorEntityName")) {
            queryParams.add("connectorEntityName=" + args.get("connectorEntityName"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_describe_connector_entity" + queryString;
    ...
    public static MCPServer.Tool createPost_Describe_Connector_EntityTool(MCPServer.APIConfig config) {
        ...
        connectorProfileNameProperty.put("description", "Input parameter: The name of the connector profile. The name is unique for each <code>ConnectorProfile</code> in the Amazon Web Services account.");
        ...
        connectorTypeProperty.put("description", "Input parameter: The type of connector application, such as Salesforce, Amplitude, and so on.");
        ...
        connectorEntityNameProperty.put("required", true);
        connectorEntityNameProperty.put("description", "Input parameter: The entity name for that connector.");
        properties.put("connectorEntityName", connectorEntityNameProperty);
        parameters.put("properties", properties);
        
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_describe_connector_entity",
            "Provides details regarding the entity used with the connector, with a description of the data model for each field in that entity.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_Describe_Connector_EntityHandler(config));
    }
