/**
 * MCP Server function for Enables your application to create a new flow using Amazon AppFlow. You must create a connector profile before calling this API. Please note that the Request Syntax below shows syntax for multiple destinations, however, you can only transfer data to one item in this list at a time. Amazon AppFlow does not currently support flows to multiple destinations at once.
 */
...
class Post_Create_FlowMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_Create_FlowHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("destinationFlowConfigList")) {
            queryParams.add("destinationFlowConfigList=" + args.get("destinationFlowConfigList"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_create_flow" + queryString;
    ...
    public static MCPServer.Tool createPost_Create_FlowTool(MCPServer.APIConfig config) {
        ...
        descriptionProperty.put("description", "Input parameter: A description of the flow you want to create.");
        ...
        tagsProperty.put("description", "Input parameter: The tags used to organize, track, or control access for your flow.");
        ...
        destinationFlowConfigListProperty.put("description", "Input parameter: The configuration that controls how Amazon AppFlow places data in the destination connector.");
        ...
        return new MCPServer.Tool(definition, getPost_Create_FlowHandler(config));
    }
