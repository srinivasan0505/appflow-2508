/**
 * MCP Server function for Updates a given connector profile associated with your account.
 */
...
class Post_Update_Connector_ProfileMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_Update_Connector_ProfileHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("connectorProfileConfig")) {
            queryParams.add("connectorProfileConfig=" + args.get("connectorProfileConfig"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_update_connector_profile" + queryString;
    ...
    public static MCPServer.Tool createPost_Update_Connector_ProfileTool(MCPServer.APIConfig config) {
        ...
        connectionModeProperty.put("description", "Input parameter: Indicates the connection mode and if it is public or private.");
        ...
        connectorProfileNameProperty.put("description", "Input parameter: The name of the connector profile and is unique for each <code>ConnectorProfile</code> in the Amazon Web Services account.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_update_connector_profile",
            "Updates a given connector profile associated with your account.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_Update_Connector_ProfileHandler(config));
    }
