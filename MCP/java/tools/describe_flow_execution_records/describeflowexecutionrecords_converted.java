/**
 * MCP Server function for Fetches the execution history of the flow.
 */
...
class Post_Describe_Flow_Execution_RecordsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_Describe_Flow_Execution_RecordsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("flowName")) {
            queryParams.add("flowName=" + args.get("flowName"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_describe_flow_execution_records" + queryString;
    ...
    public static MCPServer.Tool createPost_Describe_Flow_Execution_RecordsTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_describe_flow_execution_records",
            "Fetches the execution history of the flow.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_Describe_Flow_Execution_RecordsHandler(config));
    }
