...
func RegisterconnectorHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.RegisterConnectorrequest
		...
		url := fmt.Sprintf("%s/register-connector", cfg.BaseURL)
		...
		var result models.RegisterConnectorResponse
...
func CreateRegisterconnectorTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_register-connector",
		mcp.WithDescription("Registers a new custom connector with your Amazon Web Services account. Before you can register the connector, you must deploy the associated AWS lambda function in your account."),
		...
		mcp.WithString("connectorLabel", mcp.Description("Input parameter:  The name of the connector. The name is unique for each <code>ConnectorRegistration</code> in your Amazon Web Services account.")),
		...
		mcp.WithString("connectorProvisioningType", mcp.Description("Input parameter: The type of provisioning that the connector supports, such as Lambda.")),
		mcp.WithString("description", mcp.Description("Input parameter: A description about the connector that's being registered.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    RegisterconnectorHandler(cfg),
	}
}
