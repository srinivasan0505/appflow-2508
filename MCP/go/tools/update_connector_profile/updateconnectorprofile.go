...
func UpdateconnectorprofileHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateConnectorProfilerequest
		...
		url := fmt.Sprintf("%s/update-connector-profile", cfg.BaseURL)
		...
		var result models.UpdateConnectorProfileResponse
...
func CreateUpdateconnectorprofileTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_update-connector-profile",
		mcp.WithDescription(" Updates a given connector profile associated with your account. "),
		...
		mcp.WithString("connectionMode", mcp.Required(), mcp.Description("Input parameter:  Indicates the connection mode and if it is public or private. ")),
		...
		mcp.WithString("connectorProfileName", mcp.Required(), mcp.Description("Input parameter:  The name of the connector profile and is unique for each <code>ConnectorProfile</code> in the Amazon Web Services account. ")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateconnectorprofileHandler(cfg),
	}
}
