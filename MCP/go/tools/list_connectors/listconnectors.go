...
func ListconnectorsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/list-connectors%s", cfg.BaseURL, queryString)
...
func CreateListconnectorsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_list-connectors",
		mcp.WithDescription("Returns the list of all registered custom connectors in your Amazon Web Services account. This API lists only custom connectors registered in this account, not the Amazon Web Services authored connectors. "),
