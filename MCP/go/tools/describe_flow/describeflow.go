...
func DescribeflowHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/describe-flow", cfg.BaseURL)
		...
		var result models.DescribeFlowResponse
...
func CreateDescribeflowTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_describe-flow",
		mcp.WithDescription(" Provides a description of the specified flow. "),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DescribeflowHandler(cfg),
	}
}
