...
func DescribeconnectorsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeConnectorsrequest
		...
		url := fmt.Sprintf("%s/describe-connectors%s", cfg.BaseURL, queryString)
		...
		var result models.DescribeConnectorsResponse
...
func CreateDescribeconnectorsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_describe-connectors",
		...
		mcp.WithNumber("maxResults", mcp.Description("Input parameter: The maximum number of items that should be returned in the result set. The default is 20.")),
		mcp.WithString("nextToken", mcp.Description("Input parameter:  The pagination token for the next page of data. ")),
		mcp.WithArray("connectorTypes", mcp.Description("Input parameter:  The type of connector, such as Salesforce, Amplitude, and so on. ")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DescribeconnectorsHandler(cfg),
	}
}
