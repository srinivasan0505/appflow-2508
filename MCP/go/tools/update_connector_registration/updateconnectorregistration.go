...
func UpdateconnectorregistrationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateConnectorRegistrationrequest
		...
		url := fmt.Sprintf("%s/update-connector-registration", cfg.BaseURL)
		...
		var result models.UpdateConnectorRegistrationResponse
...
func CreateUpdateconnectorregistrationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_update-connector-registration",
		mcp.WithDescription("<p>Updates a custom connector that you've previously registered. This operation updates the connector with one of the following:</p> <ul> <li> <p>The latest version of the AWS Lambda function that's assigned to the connector</p> </li> <li> <p>A new AWS Lambda function that you specify</p> </li> </ul>"),
		...
		mcp.WithString("connectorLabel", mcp.Required(), mcp.Description("Input parameter: The name of the connector. The name is unique for each connector registration in your AWS account.")),
		mcp.WithObject("connectorProvisioningConfig", mcp.Description("Input parameter: Contains information about the configuration of the connector being registered.")),
		mcp.WithString("description", mcp.Description("Input parameter: A description about the update that you're applying to the connector.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdateconnectorregistrationHandler(cfg),
	}
}
