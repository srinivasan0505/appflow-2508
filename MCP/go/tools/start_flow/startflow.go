...
func StartflowHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.StartFlowrequest
		...
		url := fmt.Sprintf("%s/start-flow", cfg.BaseURL)
		...
		var result models.StartFlowResponse
...
func CreateStartflowTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_start-flow",
		mcp.WithDescription(" Activates an existing flow. For on-demand flows, this operation runs the flow immediately. For schedule and event-triggered flows, this operation activates the flow. "),
