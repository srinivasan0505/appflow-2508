...
func StopflowHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeFlowrequest
		...
		url := fmt.Sprintf("%s/stop-flow", cfg.BaseURL)
		...
		var result models.StopFlowResponse
...
func CreateStopflowTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_stop-flow",
		mcp.WithDescription(" Deactivates the existing flow. For on-demand flows, this operation returns an <code>unsupportedOperationException</code> error message. For schedule and event-triggered flows, this operation deactivates the flow. "),
