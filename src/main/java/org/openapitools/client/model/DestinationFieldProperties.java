...
public class DestinationFieldProperties {
  ...
  public DestinationFieldProperties isCreatable(@javax.annotation.Nullable Boolean isCreatable) {
  ...
  public DestinationFieldProperties isNullable(@javax.annotation.Nullable Boolean isNullable) {
  ...
  public DestinationFieldProperties isUpsertable(@javax.annotation.Nullable Boolean isUpsertable) {
  ...
  public DestinationFieldProperties isUpdatable(@javax.annotation.Nullable Boolean isUpdatable) {
  ...
  public DestinationFieldProperties isDefaultedOnCreate(@javax.annotation.Nullable Boolean isDefaultedOnCreate) {
  ...
  public DestinationFieldProperties supportedWriteOperations(@javax.annotation.Nullable List supportedWriteOperations) {
