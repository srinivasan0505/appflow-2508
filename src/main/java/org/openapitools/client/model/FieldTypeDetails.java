...
public class FieldTypeDetails {
  ...
  public FieldTypeDetails fieldType(@javax.annotation.Nonnull String fieldType) {
  ...
  public FieldTypeDetails filterOperators(@javax.annotation.Nonnull List filterOperators) {
  ...
  public FieldTypeDetails supportedValues(@javax.annotation.Nullable List supportedValues) {
  ...
  public FieldTypeDetails valueRegexPattern(@javax.annotation.Nullable String valueRegexPattern) {
  ...
  public FieldTypeDetails supportedDateFormat(@javax.annotation.Nullable String supportedDateFormat) {
  ...
  public FieldTypeDetails fieldValueRange(@javax.annotation.Nullable FieldTypeDetailsFieldValueRange fieldValueRange) {
  ...
  public FieldTypeDetails fieldLengthRange(@javax.annotation.Nullable FieldTypeDetailsFieldLengthRange fieldLengthRange) {
