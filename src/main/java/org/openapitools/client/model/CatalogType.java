...
public enum CatalogType {
  ...
  public static class Adapter extends TypeAdapter<CatalogType> {
    @Override
    public void write(final JsonWriter jsonWriter, final CatalogType enumeration) throws IOException {
    ...
    public CatalogType read(final JsonReader jsonReader) throws IOException {
      ...
      return CatalogType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CatalogType.fromValue(value);
  }
}
