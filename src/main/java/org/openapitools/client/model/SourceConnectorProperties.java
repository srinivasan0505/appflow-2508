...
public class SourceConnectorProperties {
  ...
  public SourceConnectorProperties amplitude(@javax.annotation.Nullable SourceConnectorPropertiesAmplitude amplitude) {
  ...
  public SourceConnectorProperties datadog(@javax.annotation.Nullable SourceConnectorPropertiesDatadog datadog) {
  ...
  public SourceConnectorProperties dynatrace(@javax.annotation.Nullable SourceConnectorPropertiesDynatrace dynatrace) {
  ...
  public SourceConnectorProperties googleAnalytics(@javax.annotation.Nullable SourceConnectorPropertiesGoogleAnalytics googleAnalytics) {
  ...
  public SourceConnectorProperties inforNexus(@javax.annotation.Nullable SourceConnectorPropertiesInforNexus inforNexus) {
  ...
  public SourceConnectorProperties marketo(@javax.annotation.Nullable SourceConnectorPropertiesMarketo marketo) {
  ...
  public SourceConnectorProperties S3(@javax.annotation.Nullable SourceConnectorPropertiesS3 S3) {
    this.S3 = S3;
    return this;
  }
  ...
  public SourceConnectorProperties salesforce(@javax.annotation.Nullable SourceConnectorPropertiesSalesforce salesforce) {
  ...
  public SourceConnectorProperties serviceNow(@javax.annotation.Nullable SourceConnectorPropertiesServiceNow serviceNow) {
  ...
  public SourceConnectorProperties singular(@javax.annotation.Nullable SourceConnectorPropertiesSingular singular) {
  ...
  public SourceConnectorProperties slack(@javax.annotation.Nullable SourceConnectorPropertiesSlack slack) {
    this.slack = slack;
    return this;
  }
  ...
  public SourceConnectorProperties trendmicro(@javax.annotation.Nullable SourceConnectorPropertiesTrendmicro trendmicro) {
  ...
  public SourceConnectorProperties veeva(@javax.annotation.Nullable SourceConnectorPropertiesVeeva veeva) {
    this.veeva = veeva;
    return this;
  }
  ...
  public SourceConnectorProperties zendesk(@javax.annotation.Nullable SourceConnectorPropertiesZendesk zendesk) {
  ...
  public SourceConnectorProperties saPOData(@javax.annotation.Nullable SAPODataSourceProperties saPOData) {
  ...
  public SourceConnectorProperties customConnector(@javax.annotation.Nullable CustomConnectorSourceProperties customConnector) {
  ...
  public SourceConnectorProperties pardot(@javax.annotation.Nullable SourceConnectorPropertiesPardot pardot) {
    this.pardot = pardot;
    return this;
  }
