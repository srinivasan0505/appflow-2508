...
public class AuthenticationConfigOAuth2Defaults {
  ...
  public AuthenticationConfigOAuth2Defaults oauthScopes(@javax.annotation.Nullable List oauthScopes) {
  ...
  public AuthenticationConfigOAuth2Defaults tokenUrls(@javax.annotation.Nullable List tokenUrls) {
  ...
  public AuthenticationConfigOAuth2Defaults authCodeUrls(@javax.annotation.Nullable List authCodeUrls) {
  ...
  public AuthenticationConfigOAuth2Defaults oauth2GrantTypesSupported(@javax.annotation.Nullable List oauth2GrantTypesSupported) {
  ...
  public AuthenticationConfigOAuth2Defaults oauth2CustomProperties(@javax.annotation.Nullable List oauth2CustomProperties) {
