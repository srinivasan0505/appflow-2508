...
public class TriggerPropertiesScheduled {
  ...
  public TriggerPropertiesScheduled scheduleExpression(@javax.annotation.Nonnull String scheduleExpression) {
  ...
  public TriggerPropertiesScheduled dataPullMode(@javax.annotation.Nullable DataPullMode dataPullMode) {
  ...
  public TriggerPropertiesScheduled scheduleStartTime(@javax.annotation.Nullable OffsetDateTime scheduleStartTime) {
  ...
  public TriggerPropertiesScheduled scheduleEndTime(@javax.annotation.Nullable OffsetDateTime scheduleEndTime) {
  ...
  public TriggerPropertiesScheduled timezone(@javax.annotation.Nullable String timezone) {
  ...
  public TriggerPropertiesScheduled scheduleOffset(@javax.annotation.Nullable Integer scheduleOffset) {
  ...
  public TriggerPropertiesScheduled firstExecutionFrom(@javax.annotation.Nullable OffsetDateTime firstExecutionFrom) {
  ...
  public TriggerPropertiesScheduled flowErrorDeactivationThreshold(@javax.annotation.Nullable Integer flowErrorDeactivationThreshold) {
